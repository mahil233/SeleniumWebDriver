...
public class PaginationTable {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//1 we need to validate if dialog box is displayed then we have to close it otherwise we can ignore it
		...
		//2 Find Total number of pages accordingly we have to click on pagination option
